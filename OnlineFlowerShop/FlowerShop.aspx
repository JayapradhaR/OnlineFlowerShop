...
<body>
    <form id="flowershop" runat="server">
       <div>
        ...
        <h2 class="design"></h2>
        <div class="page">
            <img class="flower" src="image/flower.png" />
            </div>
            <div class="column">
                ...
                <div>
                    <table style="width: 130%">
                        ...
                        <tr>
                            ...
                            <td rowspan="2">
                                <asp:Image ID="logo" runat="server" ImageUrl="~/image/Visa.png" CssClass="logo" /></td>
                        </tr>
                        <tr>
                            <td>Amount</td>
                            <td><b>£100.00</b></td>
                ...
                <div>
                    <table style="width: 100%">
                        <tr>
                            <td><asp:ImageButton ImageUrl="~/image/startAgain.png" runat="server" CssClass="imageAction"  />
                            ...
                            <td style="text-align: right">
                                ...
                                <asp:ImageButton ImageUrl="~/image/payment.png" runat="server" CssClass="imageAction" OnClick="Payment_Click" />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                                <asp:ImageButton ImageUrl="~/image/cancel.png" runat="server" CssClass="imageAction" />
                ...
                <div class="ACTION">
                    ...
                    <table style="width: 100%">
                        <tr>
                            <td><asp:Image ImageUrl="~/image/worldpay.png" runat="server" /></td>
            ...
            <div class="end">
                <asp:Image ID="question" runat="server" ImageUrl="~/image/question.png" CssClass="image" /><br />
                <asp:Image ID="questionMark" runat="server" ImageUrl="~/image/question.png" CssClass="secondImage" />
            </div>
        </div>
        <div class="footer" >
        <h1 >Thank you for shopping at Flowershop. Have a nice day</h1></div>
    </form>
     </body>
</html>
